...
$mobOpt=false;
//og-title
$main_smarty->assign('og_posttitle', 'Shaukk Testimonial');
//Site Title
$main_smarty->assign('posttitle', 'Testimonials');
//met description
...
$main_smarty->assign('tpl_center', $the_template . '/testimonial_center');
